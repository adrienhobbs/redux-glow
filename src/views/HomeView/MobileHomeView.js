...
export class HomeMobile extends PageLayout {
  ...
  showVideoReel () {
    this.player.loadVideo(217077385);
    this.showReelContainer();
  }

  showInteractiveReel () {
    this.player.loadVideo(188844228);
    this.showReelContainer();
  }
  ...
  hideOverlay () {
    TweenLite.to(this.refs.videoOverlay, 0.6, {autoAlpha: 0, ease: Circ.easeOut});
  }
    ...
    return (
      <div className={styles.mobile_home_wrap} ref='page'>
        <div className='video-overlay' ref='videoOverlay'>
          <div className='go-back' onClick={this.hideVideoReel.bind(this)}> Go Back </div>
        ...
        <div className={styles.home_mobile}>
          ...
          <div className={styles.inner_wrap}>
            ...
            <div className='reel-btns'>
              <div className='reel-btn inverse' onClick={this.showInteractiveReel.bind(this)}>view interactive reel</div>
              <div className='reel-btn inverse' onClick={this.showVideoReel.bind(this)}>view video reel</div>
            </div>
          </div>
        </div>
